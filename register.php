            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Date"
                            
							   required pattern="[0-2][0-9]|3[0-1]">
                    </div>
                </div>
				<div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Year"
